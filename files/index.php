...
<div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
        ...
        <div class="item">
            <img src="assets/img/pic1.jpg" alt="Flower">
        </div>

        <div class="item">
            <img src="assets/img/pic2.jpg" alt="Flower">
        </div>
    </div>
</div>
        ...
        <div class="row">
            ...
            <div class="col-lg-4  col-md-4 col-sm-4" data-scroll-reveal="enter from the bottom after 0.4s">
                <div class="faculty-div">
                    <img src="assets/img/faculty/p1.svg" class="img-rounded"/>
                    <h3 align="center">Prof. Bob</h3>
                    <hr/>
                    <h4 align="center">Principal<br/>Computer Engineering</h4>

                </div>
            </div>
            <div class="col-lg-4  col-md-4 col-sm-4" data-scroll-reveal="enter from the bottom after 0.5s">
                <div class="faculty-div">
                    <img src="assets/img/faculty/p2.svg" class="img-rounded"/>
                    <h3 align="center">PROF. Meow</h3>
                    <hr/>
                    <h4 align="center">Principal<br/>Mechenical Engineering </h4>

                </div>
            </div>
            <div class="col-lg-4  col-md-4 col-sm-4" data-scroll-reveal="enter from the bottom after 0.6s">
                <div class="faculty-div">
                    <img src="assets/img/faculty/p3.svg" class="img-rounded"/>
                    <h3 align="center">PROF. Jeck</h3>
                    <hr/>
                    <h4 align="center">Principal<br/>Civil Engineering</h4>
    ...
    <div class="row set-row-pad">
        <div class="col-lg-4 col-md-4 col-sm-4   col-lg-offset-1 col-md-offset-1 col-sm-offset-1 "
            ...
            <div>
                ...
                <h4> Said Anywhere</h4>
                <h4><strong>Call:</strong> 9998887776 </h4>
                <h4><strong>Email: </strong>xyz@somthing.com</h4>
            </div>
